...
| 2           | Autor(es) e revisor(es) estão identificados para o artefato?        |                Sim                    |        1.2 <br> 10/12 - 22h00        |
| 3           | Referências bibliográficas/bibliografia estão presentes no artefatos?      |   Sim                    |        1.2 <br> 10/12 - 22h00        |
| 4           | Tabelas e imagens possuem legenda e fonte, sendo chamadas no texto?    |                Sim                    |        1.2 <br> 10/12 - 22h00        |
| 5           | Há um texto de introdução do artefatos?                               |                Sim                    |        1.2 <br> 10/12 - 22h00        |
...
| ------ | ---------- | ------------------------------------------ | ----------------------------------------------- | ----------------------- |
| `1.0`  | 10/12/2024 | Criação da página                          | [Dara Maria](https://github.com/henryqma) | Davi Casseb, Henrique Alencar |
