...
![GRID](../assets/guia-estilo/GRID.png){ width="900px" }
...
![Residência](../assets/guia-estilo/residencia.png){ width="900px" }

_Autor: Neoenergia_

**Figura 3** - Página Principal

![Principal](../assets/guia-estilo/principal.png){ width="900px" }

_Autor: Neoenergia_

**Figura 4** - Exemplo de serviço

![Serviço](../assets/guia-estilo/servico.png){ width="900px" }
...
![Fonte](../assets/guia-estilo/tipografia.png){ width="600px" }

_Autor: Henrique Alencar_

**Figura 6** - Logotipo

![Logotipo](../assets/guia-estilo/logotipo.png){ width="600px" }

_Autor: Neoenergia_

**Figura 7** - Ícones

![Ícone](../assets/guia-estilo/icones.png){ width="600px" }
...
![Cores](../assets/guia-estilo/cores.png){ width="600px" }
